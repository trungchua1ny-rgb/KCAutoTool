...
Phase 3 timeline generation now requires KC Dev `2.44.0` or newer so an older ChatGPT worker cannot silently replace Beat & Chain Planning, keep generating image prompts for continuation scenes, or omit the style-reference analysis.
