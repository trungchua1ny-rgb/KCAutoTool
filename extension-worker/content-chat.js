...
- Describe one continuous, physically possible shot lasting exactly the required boundary duration without retelling the static image. Give each character ONE coherent action arc with anticipation, main movement, readable reaction, follow-through, and a brief settle. The END FRAME must clearly state the final pose and composition that can connect to the next scene.
